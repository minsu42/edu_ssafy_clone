...
> 최종 업데이트: 2026-05-12 (P1-BE 완료, P1-FE 다음 단계)

| 페이즈 | 유형 | 이름 | 상태 | 완료일 | 비고 |
|--------|------|------|------|--------|------|
| P0 | 구현 | 프로젝트 부트스트랩 | ✅ 완료 | 2026-05-11 | `feat/p0-project-bootstrap` |
| D1 | 문서화 | FR-AUTH 요구사항 보완 + API 명세 | ✅ 완료 | 2026-05-11 | `docs/api/auth.md` |
| P1-BE | 구현 | FR-AUTH 백엔드 | ✅ 완료 | 2026-05-12 | `feat/p1-fr-auth` |
| P1-FE | 구현 | FR-AUTH 프론트엔드 | ⏳ 다음 단계 | — | 라우터·레이아웃·로그인·프로필 화면 + E2E |
| D2 | 문서화 | FR-DASHBOARD 요구사항 도출 + API 명세 | ⬜ 미시작 | — | — |
