...
> 최종 업데이트: 2026-05-12 (P1 완료)

| 페이즈 | 유형 | 이름 | 상태 | 완료일 | 비고 |
|--------|------|------|------|--------|------|
| P0 | 구현 | 프로젝트 부트스트랩 | ✅ 완료 | 2026-05-11 | `feat/p0-project-bootstrap` |
| D1 | 문서화 | FR-AUTH 요구사항 보완 + API 명세 | ✅ 완료 | 2026-05-11 | `docs/api/auth.md` |
| P1 | 구현 | FR-AUTH 인증/계정 | ✅ 완료 | 2026-05-12 | `feat/p1-fr-auth` |
| D2 | 문서화 | FR-DASHBOARD 요구사항 도출 + API 명세 | ⏳ 다음 단계 | — | — |
| P2 | 구현 | FR-DASHBOARD 대시보드 | ⬜ 미시작 | — | — |
| D3 | 문서화 | FR-LECTURE 요구사항 도출 + API 명세 | ⬜ 미시작 | — | — |
| P3 | 구현 | FR-LECTURE 강의실 & 이러닝 | ⬜ 미시작 | — | — |
| D4 | 문서화 | FR-QUEST 요구사항 도출 + API 명세 | ⬜ 미시작 | — | — |
| P4 | 구현 | FR-QUEST Quest/평가 | ⬜ 미시작 | — | — |
| D5 | 문서화 | FR-COMMUNITY 요구사항 도출 + API 명세 | ⬜ 미시작 | — | — |
| P5 | 구현 | FR-COMMUNITY 커뮤니티 | ⬜ 미시작 | — | — |
| D6 | 문서화 | FR-NOTICE 요구사항 도출 + API 명세 | ⬜ 미시작 | — | — |
| P6 | 구현 | FR-NOTICE 공지/알림 | ⬜ 미시작 | — | — |
...
| JWT 발급/검증/갱신 통합 테스트 통과 | ✅ PASS — SecurityIntegrationTest 6건 |
| Repository 레이어 테스트 (Testcontainers) | ✅ PASS — UserRepositoryTest 6건, RefreshTokenRepositoryTest 4건 |
| AuthStore 상태 변이 smoke test | ✅ PASS — 프론트엔드 1건 |
| `./gradlew test` 전체 통과 | ✅ PASS — 46건 전부 GREEN |
